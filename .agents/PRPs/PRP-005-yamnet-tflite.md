...
> No hay brief origen — planificación directa. Continuación del roadmap acordado en el checkpoint dd9c514 (AGENTS.md). Las secciones heredadas se derivan de AGENTS.md/AGENTS.md.
