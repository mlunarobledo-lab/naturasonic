...
> Caso completo: PRP aprobado → ejecucion fase por fase → cierre con propagacion al brief y AGENTS.md. Cargar para ver concreto el contrato del bucle de punta a punta.
...
```
Empezando ejecucion de @.agents/PRPs/PRP-001-saas-reservas-dentales.md.
...
2. Documentar en AGENTS.md (raiz) que las tablas se crean con `ENABLE ROW LEVEL SECURITY` desde la primera migracion.
...
5. AGENTS.md aprendizajes: ningun aprendizaje previo cubre esto.
...
```
Ejecute @.agents/PRPs/PRP-001-saas-reservas-dentales.md, derivado de
