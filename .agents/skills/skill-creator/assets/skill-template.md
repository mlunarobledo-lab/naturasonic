...
- `@.agents/skills/<hermana-1>/SKILL.md` — <cuando encadenar>. Hand-off: <que pasa la una a la otra concretamente>.
- `@.agents/skills/<hermana-2>/SKILL.md` — <cuando encadenar>. Hand-off: <concreto>.
- `@.agents/skills/<hermana-3>/SKILL.md` — <cuando encadenar>. Hand-off: <concreto>.
