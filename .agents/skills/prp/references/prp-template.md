...
| **Aprendizajes heredados de fases previas** | Lecciones transversales de `AGENTS.md` o de una corrida previa del brief | Agente al generar |
...
> Voz: impersonal. Aprendizajes transversales de `AGENTS.md` que apliquen a este trabajo, o de una corrida previa parcial del mismo brief (si alguna fase ya tenia poblado `Aprendizajes para fases siguientes`).
