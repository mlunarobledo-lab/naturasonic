...
- `@.agents/skills/brief/SKILL.md` — fuente del brief que esta skill consume.
- `@.agents/skills/prp/SKILL.md` — formato del contrato entre agentes.
- `@.agents/skills/bucle-agentico/SKILL.md` — doctrina canonica del patron recursivo. Cada agente del equipo ejecuta su PRP siguiendo bucle-agentico.
...
SendMessage({
  to: 'auth-engineer',
  prompt: `Ejecuta @.agents/PRPs/PRP-XXX-auth-base.md siguiendo bucle-agentico.
...
2. AGENTS.md raiz se actualiza con aprendizajes transversales.
...
- `@.agents/skills/brief/SKILL.md` — fuente del brief.
- `@.agents/skills/prp/SKILL.md` — formato del contrato entre agentes.
- `@.agents/skills/bucle-agentico/SKILL.md` — doctrina canonica del patron recursivo.
...
- [ ] AGENTS.md raiz actualizado con aprendizajes transversales.
- [ ] Commit + push hechos.
