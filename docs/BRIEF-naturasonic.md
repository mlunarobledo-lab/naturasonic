...
- **Aprendizajes para fases siguientes**: Los modelos ML (Vosk, YAMNet) se descargan on-demand al primer uso, no van en el APK. El modelo YAMNet TFLite espera input de 15600 muestras (0.975s a 16kHz) — hay que resamplear desde 48kHz del pipeline Oboe. whisper.cpp queda como stub para integración futura (requiere NDK build separado del modelo .bin).
- **Ajustes a la Directiva de Stack**: —
- **Iniciada**: 2026-08-03
- **Completada**: 2026-08-03
