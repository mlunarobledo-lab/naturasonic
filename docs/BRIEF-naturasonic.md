...
- **Aprendizajes para fases siguientes**: Los modelos ML (Vosk, YAMNet) se descargan on-demand al primer uso, no van en el APK. El modelo YAMNet TFLite espera input de 15600 muestras (0.975s a 16kHz) — hay que resamplear desde 48kHz del pipeline Oboe. whisper.cpp integrado completamente en PRP-002 (2026-08-10): FetchContent v1.6.2, JNI bridge, descarga de modelos GGML (tiny/base), resampling 48→16kHz, UI con selector de motor y gating premium.
- **Ajustes a la Directiva de Stack**: —
- **Iniciada**: 2026-08-03
- **Completada**: 2026-08-03
