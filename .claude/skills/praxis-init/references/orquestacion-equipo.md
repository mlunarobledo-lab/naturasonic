...
> Como lanzar el equipo que radiografia el proyecto. Reutiliza los patrones de roles de `@.claude/skills/build-with-agent-team/SKILL.md`, pero en **modo analisis**: los agentes solo leen y reportan, nunca construyen.
