...
import com.naturasonic.app.ui.screens.cloudbackup.CloudBackupScreen
...
import com.naturasonic.app.ui.screens.tinnitus.TinnitusScreen
        ...
        composable(Routes.SETTINGS) {
            SettingsScreen(
                ...
                onNavigateToCloudBackup = {
                    navController.navigate(Routes.CLOUD_BACKUP)
                },
                ...
                onNavigateToTinnitus = {
                    navController.navigate(Routes.TINNITUS)
                }
            )
        }
